...
function SummaryBatchProcessingStatus(props) {
	...
	return (
		<h2 className={statusClassName()}>
			Current Summary Creation Status:{" "}
			{props.batch &&
...
SummaryBatchProcessingStatus.propTypes = {
	batch: PropTypes.object.isRequired,
};

SummaryBatchProcessingStatus.defaultProps = {
	batch: {},
};

export default SummaryBatchProcessingStatus;
